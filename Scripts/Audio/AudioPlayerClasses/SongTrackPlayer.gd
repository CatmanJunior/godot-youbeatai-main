...
func _on_section_added(_section_index: int, _tex: Texture2D) -> void:
	# if track_data.has_recording():
	# 	track_data.insert_silence_for_section(_section_index, SongState.beats_per_section, SongState.beat_duration)
	pass

func _on_section_removed(_section_index: int) -> void:
	# if track_data.has_recording():
	# 	track_data.remove_audio_for_section(_section_index, SongState.beats_per_section, SongState.beat_duration)
	pass
