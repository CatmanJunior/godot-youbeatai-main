...
public partial class AudioBank : Resource
{
	...
	[ExportSubgroup("Chords")]
	[Export] public ChordProgression[] progressions { get; set; }
	[Export] public Resource chord_soundfont { get; set; }
	[Export] public int chord_instrument_id { get; set; }
