...
func _on_achievement_done(i):
	if GameState.achievements_active:
		match i:
			...
			6:  _fill_instruction_label("Dit korte ⌚ Hi-hat geluid laat de boel lekker swingen, zet er maar eens een hele hoop neer")
			1:  _fill_instruction_label("Met de hoge 🐦 Synth, kan je het lekker druk maken, maar ook even een kort geluidje is die heel goed in.")
			...
			9:  _fill_instruction_label("Haha leuk! sleep nu de vingerafdruk naar de 🎤 op de mixer dan hoor je jou sample in de beat ring")
			2:  _fill_instruction_label("Ik weet een leuke beat voor je, in de beat ring staan nu stipjes die je een hint geven")
