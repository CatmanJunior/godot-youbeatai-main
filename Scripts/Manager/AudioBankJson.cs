...
public partial class Manager : Node
{
    ...
    private void ReadJsonFromPreviousSceneAndSetValues()
    {
        ...
        foreach (var emoticon in SoundBankSelectionMenu.chosenEmotions)
            chosen_emoticons_label.Text += emoticon;
        foreach (var emoticon in SoundBankSelectionMenu.chosenThemes)
            chosen_emoticons_label.Text += emoticon;
        ...
        bank.green_effectProfile.Apply(green_alt);
        ...
        if (!Tutorial.useTutorial)
        {
            ...
            string offsetjson = Godot
                .FileAccess.Open(path, Godot.FileAccess.ModeFlags.Read)
                .GetAsText();
            Dictionary<string, string> offsetLookup = JsonSerializer.Deserialize<
